...
-   Ohjeet löytyvät
    [täältä](https://www.fsd.tuni.fi/fi/aineistot/taustatietoa/spss-portable-r/)
...
esimerkiksi puuttuvia arvoja. Tarkastellaan seuraavassa muuttujaa b30,
"Kuinka tyytyväinen olet siihen, kuinka demokratia toimii Suomessa?".
Vastausvaihtoehtojen tulisi vaihdella välillä 0-10, mutta havaitaan
...
Lasketaan muuttujalle B30 keskiarvo ja -hajonta
...
R on varovainen puuttuvien arvojen suhteen eikä laske keskiarvoa, jos
...
keskiarvon ja -hajonnan ilman puuttuvia arvoja na.rm = TRUE
-asetuksella. Tämä jättää puuttuvat arvot huomiotta.
