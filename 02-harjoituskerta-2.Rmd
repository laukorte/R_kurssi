...
Erilaisia yhden tai kahden muuttujan kuvaajia saa tehtyä plot-komennolla. Esimerkiksi ensimmäisellä harjoituskerralla tehty älykkyysosamäärä voidaan kuvata yksinkertaisella komennolla:
...
Huomaa, että komennossa on paljon "ylimääräistä", pelkkä `plot(aly)` olisi tuottanut kuvion ilman tekstejä ja viivoja.
